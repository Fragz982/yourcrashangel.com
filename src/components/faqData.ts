...
export const CATEGORIES: { name: string; faqs: Faq[] }[] = [
  {
    ...
    faqs: [
      ...
      {
        question: "I feel a little sore but nothing seems serious — do I need a doctor?",
        answer:
          "Get checked today anyway. Crash soreness is famous for showing up on day two or three, after the adrenaline wears off — and if there's no medical record from right after the accident, the insurer will argue the pain came from somewhere else. A same-day urgent-care visit does two things: it protects your health, and it timestamps the injury. I'm an estimator, not a doctor, so this isn't medical advice — it's paperwork advice: soreness that isn't written down basically didn't happen, as far as a claim is concerned.",
      },
      {
        question: "It's dented but it drives — is it okay to keep driving it?",
        answer:
          "Check four things first: lights all work, nothing is leaking, nothing rubs the tires when you turn, and no airbag light. If a bumper or panel is hanging loose, don't gamble — a piece coming off on the freeway is a new accident. Two more reasons to limit driving it: damage can get worse (and insurers can push back on the part that got worse after the crash), and a dangling bumper can get you a fix-it ticket. When in doubt, text me a photo and I'll tell you honestly whether it can wait for the shop date or needs to sit.",
      },
      {
